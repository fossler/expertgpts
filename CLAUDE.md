...
- **Home page**: `pages/1000_Home.py` (template: `templates/1000_Home.py`)
- **Expert pages**: `pages/1001_*.py`, `pages/1002_*.py`, etc. (template: `templates/template.py`)
- **Settings page**: `pages/9999_Settings.py` (template: `templates/9999_Settings.py`)
...
- **`templates/1000_Home.py`**: Home page template
- **`templates/9999_Settings.py`**: Settings page template
- **`pages/`**: Auto-generated pages - **gitignored** (regenerated from template)
  - **`pages/1000_Home.py`**: Home page (generated from template)
  - **`pages/1001_*.py`**: Expert pages (generated from template, numbered sequentially)
  - **`pages/9999_Settings.py`**: Settings page (generated from template)
